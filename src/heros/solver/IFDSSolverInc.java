 ...
 */
public class IFDSSolverInc<N,D,M,I extends InterproceduralCFG<N, M>> extends IDESolverInc<N,D,M,IFDSSolverInc.BinaryDomain,I> {
     ...
     * {@link #solve()}.
     */
    public IFDSSolverInc(final IFDSTabulationProblem<N,D,M,I> ifdsProblem) {
